    ...
    <div class="sidebar sidebar-light sidebar-secondary sidebar-expand-md">
        ...
        <div class="sidebar-content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{route('email.create')}}" class="btn bg-indigo-400 btn-block">كتابة رسالة</a>
                </div>
            </div><!-- /actions -->
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    <a href="{{route('home.dashboard')}}" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> الرئيسية</a>
                    @if($request->keyword)
                        <a href="{{route('email.index')}}" class="breadcrumb-item"><i class="icon-drawer-in"></i> البريد الوارد</a>
                    @endif
        ...
        <div class="card">
            ...
            <div class="navbar navbar-light bg-light navbar-expand-lg border-bottom-0 py-lg-2">
                ...
                <div class="navbar-collapse text-center text-lg-left flex-wrap collapse" id="inbox-toolbar-toggle-multiple">
                    {!! $contacts->render('pagination::email') !!}
                </div>
            </div><!-- /action toolbar -->
