    ...
    <div class="page-header border-bottom-0">
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline border-0">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{route('icons.index')}}" class="breadcrumb-item"><i class="icon-thumbs-up2 mr-2"></i>{{__('admin/icons.icon')}}</a>
                    <span class="breadcrumb-item active">  {{__('admin/icons.edit_icon')}} {{$model->title}}</span>
                </div>
            </div>
        </div>
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">{{__('admin/admin.home')}}</span> -   {{__('admin/icons.edit_icon')}} "{{$model->title}}"</h4>
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">{{__('admin/icons.edit_icon')}} "{{$model->title}}"</h5>
            </div>
            ...
            <div class="card-body">
                ...
                <form class="form-validate-jquery" action="{{route('icons.update',$model->id)}}" method="POST" files="true" enctype="multipart/form-data">
                    ...
                    <div class="d-flex justify-content-end align-items-center">
                        <button type="submit" class="btn btn-primary ml-3" > {{__('admin/icons.edit_icon')}}<i class="icon-paperplane ml-2"></i></button>
                    </div>
                </form>
            </div>
        </div><!-- /form -->
